...
export class EnquiryForm {
  ...
  gender: 'Male' | 'Female' = 'Male';
    ...
    maleIcon = 'assets/male.svg';
    femaleIcon = 'assets/female.svg';
  ...
  canProceedToStep2(): boolean {
    ...
    applyGenderIcons() {
      ...
      if (this.gender === 'Male') {
        ...
        you.iconPath = this.existsAsset('assets/you-female.svg') ? 'assets/you-female.svg' : this.femaleIcon;
        spouse.iconPath = this.existsAsset('assets/spouse-female.svg') ? 'assets/spouse-female.svg' : this.maleIcon;
